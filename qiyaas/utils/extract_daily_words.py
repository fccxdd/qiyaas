...
BLOCKLIST = {
				...
				'lewd', 'lesbian', 'liberal', 'libido', 'likewise', 'lingerie', 'liquor', 'loser', 'lucifer', 'lynch',
				'mafia', 'manure', 'marijuana', 'marseille', 'magnum', 'martini', 'medicaid', 'mike', 'minority', 'missile', 'murder', 'murderer', 'muslim', 
				...
				'sad', 'sadly', 'satanic', 'seduction', 'secutive', 'servant', 'sexy', 'sex', 'sexual', 'sexually', 'sexuality', 'sexist', 'sexism', 'shoot', 'shooter', 'shotgun', 'sick', 'slaughter', 'slave', 'slavery', 'smack', 'somebody', 'someday', 'somehow', 'someone', 'sometime', 'sometimes', 'somewhat', 'somewhere',
