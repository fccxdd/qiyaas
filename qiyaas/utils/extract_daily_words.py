...
BLOCKLIST = {
				...
				'bar', 'beer', 'berlin', 'bisexual', 'bipolar', 'bitchy', 'bomb', 'bomber', 'bordeaux', 'boston', 'bostons', 'bra', 'bullet', 'burial',
				...
				'eff', 'erotica', 'extremism', 'extremist', 
				...
				'manure', 'marijuana', 'marseille', 'magnum', 'martini', 'medicaid', 'mike', 'missile', 'muslim', 
				'nowadays', 'nudity',
