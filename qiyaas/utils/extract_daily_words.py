...
BLOCKLIST = {
				...
				'mafia', 'manure', 'marijuana', 'margarita', 'marseille', 'magnum', 'martini', 'medicaid', 'mike', 'minority', 'missile', 'morphine', 'murder', 'murderer', 'murderous', 'muslim', 
				'nasty', 'nowadays', 'nudity',
				'obese', 'obesity', 'other', 'otherwise', 'one', 'onstage',
				'peck', 'pic', 'pistol', 'pixie', 'polio', 'pom', 'pope', 'poverty', 'premature', 'puke', 'purgatory', 
				'quran',
