...
BLOCKLIST = {
				...
				'cannabis', 'cancer', 'cancerous', 'carcinoma', 'catholic', 'champagne', 'chit', 'christian', 'cigarette', 'cleavage', 'cocaine', 'cockroach', 'cocktail', 'coercion', 'coffin', 'communist', 'condom', 'crack', 'crappy', 'crash', 'cremation', 'crime', 'criminal',
				...
				'handgun', 'harem', 'hijack', 'heathen', 'hepatitis', 'hex', 'hickey', 'hindu', 'hobo', 'homeless', 'homicide', 'holocaust', 'horrible', 'horror', 'hostage', 'however', 'hunk',
				...
				'mafia', 'manure', 'marijuana', 'margarita', 'marseille', 'magnum', 'martini', 'medicaid', 'mike', 'minority', 'missile', 'murder', 'murderer', 'murderous', 'muslim', 
				'nasty', 'nowadays', 'nudity',
				'obese', 'obesity', 'other', 'otherwise', 'one', 'onstage',
				'peck', 'pic', 'pistol', 'pixie', 'polio', 'pom', 'poverty', 'premature', 'puke',
				'quran',
				'rabbi', 'racial', 'racism', 'racist', 'radical', 'randy', 'redneck', 'refugee', 'roach', 'robber',
				'sad', 'sadly', 'satanic', 'seduction', 'secutive', 'servant', 'sexy', 'sex', 'sexual', 'sexually', 'sexuality', 'sexist', 'sexism', 'sheikh', 'shoot', 'shooter', 'shotgun', 'sick', 'slaughter', 'slave', 'slavery', 'smack', 'somebody', 'someday', 'somehow', 'someone', 'sometime', 'sometimes', 'somewhat', 'somewhere',
				'soviet', 'spank', 'spit', 'stringer', 'stripper', 'stupidity', 'sucker', 'suicide', 'superman', 'syphilis',
				'taboo', 'tang', 'tequila', 'terror', 'terrorism', 'terrorist', 'tho', 'thou', 'tobacco', 'toilet', 'torah', 'torture', 'twitter', 
