...
return (
    <>
    <style jsx>{`
        /* Fallback default - MUST be first so media queries override it */
        :global(.keyboard-key) {
            height: 3rem;
            font-size: 1rem;
        }
        ...
        @media screen and (min-width: 1201px) {
            ...
            .keyboard-row {
				...
				/* High-DPI Yoga laptops (1201px — 1440px) */
				@media screen and (min-width: 1201px) and (max-width: 1440px) and (max-height: 900px) {
						:global(.keyboard-key) {
								height: 3.25rem;
								font-size: 1.125rem;
								padding-left: 0.75rem;   /* add horizontal padding */
