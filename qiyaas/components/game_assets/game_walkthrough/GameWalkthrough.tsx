      ...
      >
        {validSteps[currentStep]?.title && (
          <div 
            ...
            className="text-base sm:text-base md:text-lg title-text leading-loose text-black dark:text-white fade-in"
            style={{ 
        ...
        {validSteps[currentStep]?.content && (
          <div 
            ...
            className="text-sm sm:text-sm title-text leading-loose text-black dark:text-white mt-2 fade-in-delay"
            style={{ 
              wordBreak: 'break-word', 
              overflowWrap: 'break-word',
              whiteSpace: 'normal',
